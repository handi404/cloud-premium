  ...
  <div class="app-container">
    ...
    >
      <tbody>
        <tr>
          <th width="15%">活动标题</th>
          <td width="35%">
            <b style="font-size: 14px">{{ activityInfo.activityName }}</b>
          </td>
          <th width="15%">活动时间</th>
          <td width="35%">
        ...
        <tr>
          ...
          <td>
            {{
              activityInfo.activityType == "FULL_REDUCTION"
                ? "满减"
                : "满量打折"
            }}
          </td>
    ...
    <el-dialog title="添加规则" :visible.sync="dialogRuleVisible" width="490px">
      <el-form label-width="120px">
        <el-form-item
          v-if="activityInfo.activityType == 'FULL_REDUCTION'"
          label="满减金额"
        >
        ...
        <el-form-item
          v-if="activityInfo.activityType == 'FULL_DISCOUNT'"
          label="满减件数"
        >
    ...
    <h4>
      规则列表&nbsp;&nbsp;&nbsp;
      <el-button type="" size="mini" @click="dialogRuleVisible = true"
        >添加规则</el-button
      >
    </h4>
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <el-button
            type="text"
            size="mini"
            @click="removeDataById(scope.$index)"
            >删除</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog
      title="添加活动范围"
      :visible.sync="dialogRangVisible"
      width="490px"
    >
      <div style="margin-top: 20px">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item>
            <el-button type="" @click="dialogRangVisible = false"
              >取消</el-button
            >
          </el-form-item>
        </el-form>
    ...
    <h4>
      活动范围列表&nbsp;&nbsp;&nbsp;
      <el-button type="" size="mini" @click="dialogRangVisible = true"
        >添加活动范围</el-button
      >
    </h4>
    <el-table
