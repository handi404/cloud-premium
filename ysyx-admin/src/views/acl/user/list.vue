    ...
    >
      ...
      <el-table-column label="操作" width="220" align="center">
        ...
        <template slot-scope="scope">
          <el-button type="text" size="mini" @click="showAssignRole(scope.row)"
            >分配角色</el-button
          >
          <el-button type="text" size="mini" @click="showUpdateUser(scope.row)"
            >修改</el-button
          >
          <el-button type="text" size="mini" @click="removeUser(scope.row.id)"
            >删除</el-button
          >
        </template>
      </el-table-column>
