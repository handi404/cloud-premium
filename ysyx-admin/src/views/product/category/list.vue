<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button class="btn-add" size="mini"  @click="exportData"> 导出</el-button>
      <el-button  class="btn-add" size="mini"  @click="importData"> 导入</el-button>
    ...
    <el-form label-position="right" label-width="170px">
        <el-form-item label="文件">
            <el-upload
                       ...
                       :action="'http://localhost:8200/admin/product/category/importData'"
                       class="upload-demo">
...
exportData() {
    window.location.href = 'http://localhost:8203/admin/product/category/exportData'
},
importData() {
